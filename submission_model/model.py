...
#     Must return a model where:
#         model(input_ids) -> logits of shape (batch, seq_len, 50257)
#     """
#     import torch

#     # Be robust to CPU-only grading environments.
#     if device != "cpu" and not torch.cuda.is_available():
#         device = "cpu"

#     device = torch.device(device)

#     # Always load checkpoint onto CPU first.
#     # Avoid weights_only=True for grader compatibility.
