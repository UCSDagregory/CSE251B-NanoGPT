...
# -----------------------------------------------------------------------------
# I/O
eval_interval = 5       # eval every 500 iters -- saves time vs every 50
log_interval = 10         # log every 10 iters -- less console spam
eval_iters = 50           # 50 batches per eval -- stable loss estimates
eval_only = False         # if True, script exits right after the first eval
iters_per_checkpoint = 5  # save checkpoint every 2500 iters
max_checkpoints_to_keep = 3  # keep disk usage low
...
# training length
max_iters = 20        # ~6.5B tokens seen. Adjust down if running out of time.
