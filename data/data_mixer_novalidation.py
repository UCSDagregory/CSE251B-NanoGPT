...
#
# This version intentionally does not create, overwrite, delete, validate, or
# aggregate val.bin. Use your separate true val.bin for final validation.
...
def validate_args(
    ...
    if existing and not overwrite:
        raise FileExistsError(
            "Output directory already contains train*.bin or mix_metadata.txt. "
...
def main():
    parser = argparse.ArgumentParser(
        description=(
            ...
            "This script does not generate val.bin."
        )
    )
    ...
    parser.add_argument(
        "input_dirs",
        nargs="+",
        help="Input directories containing train.bin or trainN.bin.",
    )
    ...
    parser.add_argument(
        "--overwrite",
        action="store_true",
        help="Overwrite existing train*.bin and mix_metadata.txt in output directory. Does not touch val.bin.",
    )
